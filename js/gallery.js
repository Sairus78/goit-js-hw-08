...
if (container) {
  container.insertAdjacentHTML('beforeend', generateProductsMarkup(images));
} else {
  console.error('Елемент з класом .gallery не знайдено в документі.');
}
function generateProductsMarkup(images) {
  return images
    .map(image => {
      return `
